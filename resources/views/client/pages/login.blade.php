                        ...
                        <div class="login-form">
                            ...
                            <form method="post" action="{{ url('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" placeholder="Numero de Telephone " required>
                                </div>
                                ...
                                <div class="form-group pass">
                                    <a  href="{{ url('register') }}" class="psw">Créer Un compte</a>
                                    <a class=" offset-2" href="{{ url('#') }}" class="psw">Mot de Passe oublié?</a>
                                </div>
                            </form>
                        </div>
                        <!--End Login Form -->
        ...
        <div class="inner-palate">
            ...
            <div class="lower-options">
                ...
                <div class="palate-foo">
                    <span>You will find much more options for colors and styling in admin panel. This color picker is
                        used only for demonstation purposes.</span>
                </div>
