            ...
            prototype: {
                ...
                elementValue: function (t) {
                    ...
                    return n === "radio" || n === "checkbox"
                        ? e(
                              "input[name='" + e(t).attr("name") + "']:checked"
                          ).val()
                        : typeof r == "string"
                        ? r.replace(/\r/g, "")
                        : r;
                ...
                customDataMessage: function (t, n) {
                    return (
                        ...
                        (t.attributes &&
                            e(t).attr("data-msg-" + n.toLowerCase()))
                    );
                },
                ...
                return (
                    e.each(t, function (r, i) {
                        ...
                        if (i.param || i.depends) {
                            ...
                            s
                                ? (t[r] = i.param !== undefined ? i.param : !0)
                                : delete t[r];
                        }
                    }),
                    e.each(t, function (r, i) {
            ...
            methods: {
                ...
                remote: function (t, n, r) {
                    ...
                    this.settings.messages[n.name] ||
                        (this.settings.messages[n.name] = {}),
                        (i.originalMessage =
                            this.settings.messages[n.name].remote),
                        ...
                        e.ajax(
                            e.extend(
                                !0,
                                {
                                    ...
                                    data: o,
                                    success: function (r) {
                                        s.settings.messages[n.name].remote =
                                            i.originalMessage;
                                        var o = r === !0 || r === "true";
                                        if (o) {
